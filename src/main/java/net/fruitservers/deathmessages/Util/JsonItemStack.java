...
public class JsonItemStack {
    ...
    public static String toJson(ItemStack itemStack) {
        ...
        itemJson.addProperty("text", itemName);
        ...
        if (itemStack.hasItemMeta()) {
            ...
            if (meta.hasEnchants()) {
                ...
                meta.getEnchants().forEach((enchantment, integer) -> enchants.add(new JsonPrimitive(enchantment.getKey().toString())));
            ...
            if (meta instanceof SkullMeta) {
                ...
                if (esmeta.hasStoredEnchants()) {
                    ...
                    esmeta.getStoredEnchants().forEach((enchantment, integer) -> storedEnchants.add(new JsonPrimitive(enchantment.getKey().toString())));
                ...
                if (femeta.hasEffect() && femeta.getEffect() != null) {
